...
#     def train(self, epoch, model, train_dataloader, optimizer, lr_scheduler, accelerator, args, starting_epoch, resume_step):
...
#     def evaluate(self, epoch, model, tokenizer, eval_dataloader, eval_dataset, output_dir, accelerator, args):
