...
def _attribution_visualize(all_predic_toks, important_indices):
    text = " "
...
def explain_attribution(model, input, predict_label, **kwargs):
    ...
    all_predic_toks, ordered_predic_tok_indices = attribution_explainer.get_sorted_important_tokens(input, label_idx)
    ...
    html_text = _attribution_visualize(all_predic_toks, important_indices)
